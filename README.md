...
usage: check_saphana_health.py [-h] --hostname HOSTNAME --username USERNAME --password PASSWORD --sqlport SQLPORT [--mode MODE]
                               [--warning WARNING] [--critical CRITICAL] [--alert_filter ALERT_FILTER] [--timeout TIMEOUT]
...
required named arguments:
  ...
  --mode MODE           backup_data, backup_log , version, cpu, memory, mem_host, services, services_all, license_usage, db_data,
                        db_log, db_trace, alert, sid, log_usage, raw_record_count, plc_replication, backup_alert
  ...
  --alert_filter ALERT_FILTER
                        comma seperated list of alert ids to use with mode alert
